...
// Originator - создает и восстанавливает состояния
...
Использую два стека - один для истории (undo), другой для отмененных действий (redo). 
При каждом изменении сохраняю снимок в undo-стек. При отмене - переносим в redo-стек.
