...
/*
 Чтобы корректно обработать ситуацию, когда запрос не обрабатывается ни одним из обработчиков, я внес такие изменения:
...
namespace T10ChainofResponsibilityPattern
{
    ...
    class SupportHandler : Handler
    {
        ...
        // допустим, что до 50к, остальное вне регламента
        protected override bool CanHandle(ReturnRequest request)
        {
