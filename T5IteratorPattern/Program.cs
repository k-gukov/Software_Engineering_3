...
Изменения, которые я внёс в программу:
...
class Program
{
    static void Main(string[] args)
    {
        ...
        productCatalog.AddProduct(new Product("P001", "Ноутбук", "Электроника", 899.99m, 95));
        productCatalog.AddProduct(new Product("P002", "Смартфон", "Электроника", 599.50m, 98));
        productCatalog.AddProduct(new Product("P003", "Футболка", "Одежда", 24.99m, 85));
        productCatalog.AddProduct(new Product("P004", "Джинсы", "Одежда", 79.99m, 88));
