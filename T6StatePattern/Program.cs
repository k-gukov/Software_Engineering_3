...
namespace T6StatePattern
{
    ...
    public class Order
    {
        ...
        // метод для установки состояния (внутренний для контроля переходов)
...
1. Логика переходов инкапсулирована в классах состояний - каждое состояние "знает" только допустимые следующие состояния
